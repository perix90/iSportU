...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([[NSUserDefaults standardUserDefaults] boolForKey:@"tutorial_already_displayed"] == NO)
    {
        ...
        UINavigationController*   rootViewController = [storyboard instantiateViewControllerWithIdentifier:@"Tutorial"];
        self.window.rootViewController = rootViewController;
        [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"tutorial_already_displayed"];
        
    }else{
        
        UITabBarController*   rootViewController = [storyboard instantiateViewControllerWithIdentifier:@"App"];
        self.window.rootViewController = rootViewController;
    ...
    // Initialize Parse.
    [Parse setApplicationId:@"rSrV7btEZZNrrHDCkzPPLuwxFSUvURPLrYCYwaWz"
                  clientKey:@"aQ0zUHGucoBB1WSGXSr7WL6QaJFir9ZOo0ozHl3Q"];
